export const regExps = {
  strictlyAlphabetic: /^[a-ö]+$/ig,
  partlyAlphabetic: /[a-ö]+/ig,
  strictlyNumeric: /^\d+$/g,
  partlyNumeric: /\d+/g,
};

export const containsAlphabetics = (domainName) => matchesRegExp(domainName, regExps.partlyAlphabetic);
export const containsNumerics = (domainName) => matchesRegExp(domainName, regExps.partlyNumeric);
export const getDomains = (domainName) => domainName.split('.');
export const getLength = (domainName) => getBaseLevelDomain(domainName).replace('.', '').length;
export const isAlphabetic = (domainName) => matchesRegExp(domainName, regExps.strictlyAlphabetic);
export const isHyphenated = (domainName) => domainName.includes('-');
export const isNumeric = (domainName) => matchesRegExp(domainName, regExps.strictlyNumeric);
